let places = ["Turkey", "Paris", "Dubai", "Switzerland", "Italy"];
console.log("Original Orders:", places);

console.log("Alphabetical Order:",[...places].sort());

console.log("still in its original orders", places);
...
console.log("again original array reversed", places.reverse());